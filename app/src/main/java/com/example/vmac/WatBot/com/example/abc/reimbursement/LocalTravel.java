...
public class LocalTravel extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new com.example.vmac.WatBot.com.example.abc.reimbursement.LocalTravelTravelFragment();
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.travel_button) {
            ...
            //bundle.putString("travelFrom",travelFrom);
            //bundle.putString("travelTo", travelTo);
            fragment = new com.example.vmac.WatBot.com.example.abc.reimbursement.LocalTravelTravelFragment();
            fragment.setArguments(bundle);
            ...
            //bundle.putString("travelFrom",travelFrom);
            //bundle.putString("travelTo", travelTo);
            fragment = new com.example.vmac.WatBot.com.example.abc.reimbursement.LocalTravelMealFragment();
            fragment.setArguments(bundle);
